...
MAX(bloodpressure) AS MaxBP FROM insurance_data
...
-- 10. Write a SQL query to update the claim amount for the patient with PatientID = 123 to 5000.

UPDATE insurance_data SET claim = '5000' WHERE PatientID = '123';
